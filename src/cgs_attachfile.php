        ...
        <main class="main">
            ...
            <section class="content">
                   ...
                   <div class="row" style="margin-bottom:20px;">
                      ...
                      <label>Manage Attachfile For: <?php echo $_SESSION["typhoonname"]; ?></label>
                   </div>
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true"  >
                            <div class="panel panel-default" style="background-color:rgba(0,0,0,0.1); padding:0px; padding-left: 5px; padding-right:5px; border:1px solid rgba(0,0,0,0.2);">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                   ...
                                   <form class="form-inline" method="POST" action="upload_file/upload_file_cgs.php" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-12" style=" padding-left:10px; margin-bottom:15px;"><button title="Upload Online" type="submit" name="submit" id="add"  > &nbsp; UPLOAD &nbsp; </button>   &nbsp;&nbsp;<a style="background-color:orange; padding:4px; padding-left:10px; padding-right:10px; color:white;" title="Cancel Upload" href="cgs_attachfile.php"> CANCEL</a>  </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="data-table" class="table">
                                ...
                                <?php
                                    ...
                                    $row = $conn->query("SELECT * FROM `cgs_attachfile` WHERE typhoon_name='".$tname."' and mun='".$u_mun."' ORDER BY addeddate DESC") or die(mysqli_error());
                                ...
                                ?>
                                    ...
                                    ?>
                                        <td style="padding:0px;width:37px;"><a title="Delete File" href="upload_file/delete_cgs.php?file=<?php echo $fetch['filepath']?>&id=<?php echo $fetch['tid']?>&name=<?php echo $name[2]?>" class="btn btn-danger"><i class="zmdi zmdi-delete"></i></a></td>
                                        <td style="padding:0px;width:99px;"><a title="Download File" href="upload_file/download_cgs.php?file=<?php echo $name[2]?>" class="btn btn-primary"><i class="zmdi zmdi-download"></i> Download</a></td>
