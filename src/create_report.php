...
<div class="user">
    <div class="user__info r2">
        <img class="user__img" src="img/Hospital_100px.png" alt="">
        <div>
            <div class="h5"><a href="#">Create Report</a></div>
                    ...
                    <ul class="navigation">
                        ...
                        <li class="navigation__active h5"><a href="index2.php"><i><img class="user__img" src="img/Versions_100px.png" alt=""></i>  All Report</a></li>
