...
//===============================================SELECT UPDATE===============================================================================================================================
    ...
    $stmt->execute();
    $profi11 = $stmt->fetch(PDO::FETCH_ASSOC);
                ...
                <div class="scrollbar-inner">
                   <?php include('include/user_profile.php')?>
                    ...
                    <ul class="navigation">
                       ...
                       <li style="margin-bottom:2px;"> <a style="padding:0px; margin:0px;" href="changepass_user.php"> <button style="width:100%; text-align:left;" class="btn btn-light btn--icon-text">&nbsp;&nbsp;&nbsp;&nbsp;<i class="zmdi zmdi-key"></i> &nbsp;&nbsp;&nbsp;&nbsp;My Account</button> </a> </li>
                    <li><a  id="prt1" href="damage_assess.php"  style="background-color:rgba(0,0,0,0.2); width:60px; height:20px; float:right; text-align:center; padding:0px; border:1px solid grey ">Back</a> </li>
                                                ...
                                                <div class="card-body" style="padding:0px;">
                                                    <div class="tab-container" style=" margin:0px;">
                                                        <ul class="nav nav-tabs" role="tablist">
                                                              <li class="nav-item"  >
                                                                  <a class="nav-link" data-toggle="tab" href="#summarye" role="tab" style="border-bottom: 1px solid rgba(0,0,0,0.1);">DAMAGE ASSESSMENT REPORT OF ( <?=strtoupper($u_mun)?> )</a>
                                                              </li>
                                                        </ul>
                                                                        ...
                                                                        <div class="card-body" style="padding:4px;">
                                                                                  ...
                                                                                  <div class="input-group" style="margin-bottom: 4px; ">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                          <input type="text" class="form-control" value="<?=$profi11['t_em']?>"  name="t_em1"  style=" border-left:none; padding:6px; color:#939999; font-weight:bold; border-bottom: 1px solid rgba(0,0,0,0.1);" placeholder="" value="TYPHOON"  >
                                                                                  ...
                                                                                  <div class="input-group" style="margin-bottom:4px;">
                                                                                      ...
                                                                                      <div class="form-group">
                                                                                          <input style=" padding:6px;  color:white;  border-left:none; border-bottom: 1px solid rgba(0,0,0,0.1);" value="<?=$profi11['d_oc']?>" name="d_oc1" id="myText" onchange="success()" type="text" class="form-control datetime-picker"  placeholder="" >
                                                                                          <i class="form-group__bar"></i>
                                                                                      </div>
                                                                                  </div>
                                                                                  ...
                                                                                  <div class="input-group" style="margin-bottom: 4px;">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                          <input type="text" class="form-control" value="<?=$profi11['s_r']?>"  name="s_r1" style=" border-left:none; padding:6px; color:#939999; font-weight:bold; border-bottom: 1px solid rgba(0,0,0,0.1);"  placeholder="" >
                                                                                          <i class="form-group__bar"></i>
                                                                                      </div>
                                                                                  </div>
