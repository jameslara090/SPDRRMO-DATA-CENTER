            ...
            <aside class="sidebar">
                <div class="scrollbar-inner">
                  <?php include('include/user_profile.php')?>
                    ...
                    <ul class="navigation">
                       <?php if ($_SESSION['u_mun']=="cgs sorsogon"){?>
                            <li style="margin-bottom:1px; "> <a style="padding:0px; margin:0px;" href="cgs_home.php"> <button style="width:100%; text-align:left;" class="btn btn-light btn--icon-text">&nbsp;&nbsp;&nbsp;<i class="zmdi zmdi-home"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home</button> </a> </li>
                        <?php }else{ ?>
            ...
            <section class="content">
                <div class="content__inner">
                 <header class="content__title">
                   ...
                   <form action="changepass_user.php" method="post">
                   <div class="row" style="">
