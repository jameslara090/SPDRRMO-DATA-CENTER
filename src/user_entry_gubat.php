    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        if(isset($_POST['update'])){
            ...
            try{
                    ...
                    $stmt->execute();
                    if ($num < 1){  echo "<script>alert('  ✉ MESSAGE \\n  ✔ Successfully updated : ( ".$_POST['brgy']." ) Not Affected '); window.location='user_entry_gubat.php'</script>";
                    }else{  echo "<script>alert('✔ Successfully updated : ( ".$_POST['brgy']." ) Affected '); window.location='user_entry_gubat.php'</script>";  }
        ...
        if(isset($_POST['decamped'])){
            try{
                    ...
                    $stmt->execute();
                    echo "<script>alert('  ✉ MESSAGE \\n  ✔ Successfully Decamped in : ( ".$_POST['tdatetime']." ) '); window.location='user_entry_gubat.php'</script>";
                }
                catch (Exception $e){  echo $e->getMessage() . "<br/>";  while($e = $e->getPrevious()) {  echo 'Previous Error: '.$e->getMessage() . "<br/>"; }
                }
        }
        if(isset($_POST['delete'])){
            try{
                    ...
                    echo "<script>alert('  ✉ MESSAGE \\n  ✔ Successfully Deleted : ( ".$_POST['tdatetime']." ) Record '); window.location='user_entry_gubat.php'</script>";
                }
                catch (Exception $e){  echo $e->getMessage() . "<br/>";  while($e = $e->getPrevious()) {  echo 'Previous Error: '.$e->getMessage() . "<br/>"; }
                }
        }
        if(isset($_POST['add'])){
            ...
            try{
              if($_POST['tdatetime']==""){ } else{
                ...
                echo "<script>alert('  ✉ MESSAGE \\n  ✔ Successfully Added'); window.location='user_entry_gubat.php'</script>";
              }
                }
                catch (Exception $e){  echo $e->getMessage() . "<br/>";  while($e = $e->getPrevious()) {   echo 'Previous Error: '.$e->getMessage() . "<br/>";  }
                }
            ...
            <section class="content">
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true"  >
                                <div class="panel panel-default" style="background-color:rgba(0,0,0,0.1); padding:0px; padding-left: 5px; padding-right:5px; border:1px solid rgba(0,0,0,0.2);">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                          <form action="user_entry_gubat.php" method="post">
                                                ...
                                                <table id="table" class="table" >
                                                    ...
                                                    <tbody>
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy" value="Ariman" style="width:200px; height:100%; margin:0px; text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy1" value="Bagacay" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy2" value="Balud Del Norte (Pob.)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy3" value="Balud Del Sur (Pob.)" style="width:200px; height:100%; margin:0px; text-align:left; padding-left:8px; background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy4" value="Benguet" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy5" value="Bentuco" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy6" value="Beriran" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy7" value="Buenavista" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy8" value="Bulacao" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy9" value="Cabigaan" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy10" value="Cabiguhan" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy11" value="Carriedo" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy12" value="Casili" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy13" value="Cogon" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy14" value="Cota Na Daco (Pob.)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy15" value="Dita (Estillero Origin)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy16" value="Jupi (Estillero Origin)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy17" value="Lapinig" style="width:200px; height:100%; margin:0px; text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy18" value="Luna-Candol (Pob.)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy19" value="Manapao" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy20" value="Manook (Pob.)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy21" value="Naagtan" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy22" value="Nato" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy23" value="Nazareno" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy24" value="Ogao" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <!-- end old=============================================================================================================================== -->
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy25" value="Paco" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy26" value="Panganiban (Pob.)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy27" value="Paradijon (Pob.)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy28" value="Patag" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy29" value="Payawin" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy30" value="Pinontingan (Pob.)" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy31" value="Rizal" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy32" value="San Ignacio" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy33" value="Sangat" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy34" value="Santa Ana" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy35" value="Tabi" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy36" value="Tagaytay" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy37" value="Tigkiw" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy38" value="Tiris" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy39" value="Togawe" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy40" value="Union" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px; background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                                        ...
                                                        <tr style="border:1px solid #2b4c4a;">
                                                            <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;"><input type="text"   name="brgy41" value="Villareal" style="width:200px; height:100%; margin:0px;  text-align:left; padding-left:8px;  background-color:rgba(0,0,0,0.2); border:none; color:#a8b6b5;" readonly> </td>
                                            ...
                                            <div class="row" style="margin-bottom:15px;">
                                               <div class="col-sm-3"><button title="Save to Database (Note: Date & Time Required to { enable this Save Button } )" type="submit" name="add" id="add" disabled > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; SAVE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </button>   &nbsp;&nbsp;<a style="background-color:orange; padding:4px; padding-left:20px; padding-right:20px; color:white;" title="Cancel Add" href="user_entry_gubat.php"> CANCEL</a>  </div>
                                ...
                                <div class="panel panel-default" style="background-color:rgba(0,0,0,0.1); padding:0px; padding-left: 5px; padding-right:5px; border:1px solid rgba(0,0,0,0.2);">
                                    ...
                                    <div id="collapseTree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTree">
                                        <div class="panel-body">
                                         <form action="user_entry_gubat.php" method="post" style=" width:500px;">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse<?php echo $updatestat;?>" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                         <form action="user_entry_gubat.php" method="post">
                                            ...
                                            <div class="row" style="margin-bottom:15px;">
                                               <div class="col-sm-3"><button title="Save Changes" type="submit" name="update" > &nbsp;&nbsp;&nbsp; SAVE CHANGES &nbsp;&nbsp;&nbsp; </button>   &nbsp;&nbsp;<a style="background-color:orange; padding:4px; padding-left:20px; padding-right:20px; color:white;" title="Cancel Edit" href="user_entry_gubat.php"> CANCEL</a>  </div>
                                               <div class="col-sm-3"></div>
                                               <div class="col-sm-3"></div>
                                               <div class="col-sm-3"></div>
                                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="user_entry_gubat.php?trig=fil" method="post" style=" width:250px; height:33px; padding:0px; margin:0px;">
                            ...
                            <table id="data-table" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="3" style="border:1px solid rgba(0,0,0,0.4); background-color:rgba(0,0,0,0.2); padding:0px; vertical-align : middle;text-align:center;">Status</th>
                                        <th rowspan="3" style="border:1px solid rgba(0,0,0,0.4); background-color:rgba(0,0,0,0.2); padding:0px;  vertical-align : middle;text-align:left; padding-left:8px;">(42) Barangay</th>
                                        <th rowspan="3" style="border:1px solid rgba(0,0,0,0.4); background-color:rgba(0,0,0,0.2); padding:0px; vertical-align : middle;text-align:center;">#</th>
                                        <th colspan="4" style="border:1px solid rgba(0,0,0,0.4); background-color:rgba(0,0,0,0.2); padding:0px; vertical-align : middle;text-align:center;">Evacuees</th>
                                        <th rowspan="3" style="border:1px solid rgba(0,0,0,0.4); background-color:rgba(0,0,0,0.2); padding:0px; vertical-align : middle;text-align:center;">Evacuation Center</th>
                                        <th rowspan="3" style="border:1px solid rgba(0,0,0,0.4); background-color:rgba(0,0,0,0.2); padding:0px; vertical-align : middle;text-align:center;">Missing</th>
                                ...
                                ?>
                                    <tr style="border:1px solid #2b4c4a;" data-toggle="popover" data-placement="left" data-html="true" data-content=" <span style=font-size:11px;> <?='<span style=color:green;>Added Date: </span> '.$res_act['tdatetime'].'<br><span style=color:green;>Action Under Taken: </span> <textarea id=d wrap=off cols=37 rows=8 style=background-color:rgba(0,0,0,0);color:white; readonly >'.$res_act['act'].'</textarea>' ?></span>  ">
                                        <td style="border:1px solid #2b4c4a; padding:0px; vertical-align : middle;text-align:center; color:#a8b6b5;">
                                            <a title="Edit ( <?=$valuetf['brgy']?> )" href="user_entry_gubat.php?id=<?=$valuetf['tid']?>" style="padding-left:5px;padding-right:5px; border-radius:50px;" ><i class="zmdi zmdi-edit" ></i></a>
                                        </td>
                                        ...
                                        <td style="border:1px solid #2b4c4a; padding:2px; vertical-align : middle;text-align:center; color:#a8b6b5;"><?=$valuetf['num']?></td>
