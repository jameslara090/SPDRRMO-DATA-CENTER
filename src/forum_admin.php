            ...
            <aside class="sidebar">
                <div class="scrollbar-inner">
                    ...
                    <li style="margin-bottom:1px; "> <a style="padding:0px; margin:0px;" href="index2.php"> <button style="width:100%; text-align:left;" class="btn btn-light btn--icon-text">&nbsp;&nbsp;&nbsp;<i class="zmdi zmdi-home"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home</button> </a> </li>
                       ...
                       <li style="margin-bottom:1px; border-left:3px solid green; margin-top:15px;"> <a style="padding:0px; margin:0px;" href="forum_admin.php"> <button style="width:100%; text-align:left;" class="btn btn-light btn--icon-text">&nbsp;&nbsp;&nbsp;<i class="zmdi zmdi-comments"></i> &nbsp;&nbsp;&nbsp;&nbsp;Forum / Suggestions</button> </a> </li>
                    </ul>
                </div>
            </aside>
            ...
            <style>
                ...
                <img src="img/avatars/avatar-4.jpg" width="36" height="36" class="rounded-circle mr-2" alt="Stacie Hall">
                                ...
                                <small class="float-right text-navy"><?=$val['addeddate']?> <?php if($val['mun']==strtoupper($curr_user['name'])){?>&nbsp;&nbsp;<a id="<?=$val['iid']?>">❌</a><?php } ?></small>
											...
											<p class="mb-2" id="dis" style="pointer-events:none"><strong><?=$val['mun']?></strong></p>
											<p id="dis" style="pointer-events:none"><?=$val['content']?></p>
                                            ...
                                            $stmt = $connf->prepare("SELECT * FROM users WHERE user_id='".$_SESSION['user_id']."' ");
                                            $stmt->execute(); 
                                ...
                                $stmt = $connuser->prepare("SELECT * FROM users WHERE user_id='".$_SESSION['user_id']."' ");
                                $stmt->execute(); 
                        ...
                        <div class="modal fade" id="modal-large" tabindex="-1">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="upload_file/upload_ftopic.php?utype=admin" enctype="multipart/form-data">
